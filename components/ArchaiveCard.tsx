...
const ArchaiveCard = ({github,link,title,des,ListItem}:props) => {
  return (
    <article className="w-full h-80 rounded-lg bg-[#112240] p-4 flex flex-col justify-center gap-6 group">
        ...
        <a href={link} target="_balnk" className=" hover:-translate-y-2 transtisotion-transform duration-300" title="View the Project in a new window"><RxOpenInNewWindow className="text-2xl text-white hover:text-textGreen"/></a>
        </div>
