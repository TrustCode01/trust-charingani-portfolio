...
const UI = () => {
  return (
    ...
    transition={{duration:0.6, delay:0.1}}>
        <header>
            <h3 className='text-3xl font-bold'>User Interface and User Experience Design</h3>
        ...
        <ul className='mt-4 list-none'>
         <li className=' flex gap-2 py-4 items-center text-white'>
               <span><AiFillThunderbolt className="text-textGreen" /></span>
               <div className="">
                <h4 className='text-xl font-bold'> User-Centered Design Thinking</h4>
            ...
            <li className=' flex gap-2 py-4 items-center text-white'>
               <span><AiFillThunderbolt className="text-textGreen" /></span>
               <div className="">
                <h4 className='text-xl font-bold'> Responsive and Accessible Interfaces</h4>
             ...
             <li className=' flex gap-2 py-4 items-center text-white'>
               <span><AiFillThunderbolt className="text-textGreen" /></span>
               <div className="">
                <h4 className='text-xl font-bold'> Intuitive Interaction and Workflow Design</h4>
            ...
            <li className=' flex gap-2 py-4 items-center text-white'>
               <span><AiFillThunderbolt className="text-textGreen" /></span>
               <div className="">
                <h4 className='text-xl font-bold'> Multi-Language and Localization Support</h4>
            ...
            <li className=' flex gap-2 py-4 items-center text-white'>
               <span><AiFillThunderbolt className="text-textGreen" /></span>
               <div className="">
                <h4 className='text-xl font-bold'>Prototyping and Usability Testing</h4>
