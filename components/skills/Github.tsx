...
const Github = () => {
  return (
    <section className='text-white'>
      <h3 className="font-bold text-2xl">Git and Github</h3>
      <p className="text-sm  pb-4">Version control and collaboration</p>
      ...
      <ul className='mt-4 list-none'>
         <li className=' flex gap-2 py-4 items-center '>
               <span><AiFillThunderbolt className="text-textGreen" /></span>
                <div className="">
                <h4 className="text-xl font-bold py-2"> Version Control with Git</h4>
          ...
          <li className=' flex gap-2 py-4 items-center '>
               <span><AiFillThunderbolt className="text-textGreen" /></span>
               <div className="">
                <h4 className="text-xl font-bold py-2">Collaboration on GitHub</h4>
            ...
            <li className=' flex gap-2 py-4 items-center'>
               <span><AiFillThunderbolt className="text-textGreen" /></span>
               <div className="">
                <h4 className="text-xl font-bold py-2">Open Source Contribution</h4>
            ...
            <li className=' flex gap-2 py-4 items-center'>
               <span><AiFillThunderbolt className="text-textGreen" /></span>
               <div className="">
                <h4 className="text-xl font-bold py-2">Code Quality and Documentation</h4>
            ...
            <li className=' flex gap-2 py-4 items-center'>
               <span><AiFillThunderbolt className="text-textGreen" /></span>
               <div className="">
                <h4 className="text-xl font-bold py-2">Security and Best Practices</h4>
